        ...
        public void onSensorChanged(SensorEvent event) {
            if(event.sensor.getType() == Sensor.TYPE_LIGHT){
                ...
                if (event.values[0] < 25){
                    iv_background.setBackgroundResource(R.color.black);
                    textLIGHT_available.setTextColor(getResources().getColor(R.color.white));
                    textLIGHT_reading.setTextColor(getResources().getColor(R.color.white));
                    tv_test.setTextColor(getResources().getColor(R.color.white));
                }

                else {
                    iv_background.setBackgroundResource(R.color.white);
                    textLIGHT_available.setTextColor(getResources().getColor(R.color.black));
                    textLIGHT_reading.setTextColor(getResources().getColor(R.color.black));
